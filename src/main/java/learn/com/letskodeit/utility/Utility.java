package learn.com.letskodeit.utility;
...
// this method will assert expected and actual text
    ...
    public  static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/learn/com/letskodeit/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/learn/com/letskodeit/screenshots/" + screenshotName + dateName + ".png";
